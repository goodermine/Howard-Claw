...
object ModelRegistry {
    ...
    private val models = listOf(
        // Thinking models
        ModelInfo("qwen3-0.6b", "Qwen3 0.6B", "Thinking", "0.6B", 490, 1f,
            "https://huggingface.co/bartowski/Qwen_Qwen3-0.6B-GGUF/resolve/main/Qwen_Qwen3-0.6B-Q4_K_M.gguf",
            "qwen3-0.6b-q4km.gguf"),
        ModelInfo("qwen3-1.7b", "Qwen3 1.7B", "Thinking", "1.7B", 1100, 2f,
            "https://huggingface.co/bartowski/Qwen_Qwen3-1.7B-GGUF/resolve/main/Qwen_Qwen3-1.7B-Q4_K_M.gguf",
            "qwen3-1.7b-q4km.gguf"),
        ModelInfo("qwen3-4b", "Qwen3 4B", "Thinking", "4B", 2600, 3.5f,
            "https://huggingface.co/bartowski/Qwen_Qwen3-4B-GGUF/resolve/main/Qwen_Qwen3-4B-Q4_K_M.gguf",
            "qwen3-4b-q4km.gguf"),

        // Standard models
        ModelInfo("smollm3-3b", "SmolLM3 3B", "Standard", "3B", 2000, 3f,
            "https://huggingface.co/bartowski/SmolLM3-3B-GGUF/resolve/main/SmolLM3-3B-Q4_K_M.gguf",
            "smollm3-3b-q4km.gguf"),
        ModelInfo("gemma2-2b", "Gemma 2 2B", "Standard", "2B", 1500, 2.5f,
            "https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/resolve/main/gemma-2-2b-it-Q4_K_M.gguf",
            "gemma2-2b-q4km.gguf"),

        // Agent models
        ModelInfo("llama31-8b", "Llama 3.1 8B", "Agent", "8B", 4600, 5.5f,
            "https://huggingface.co/bartowski/Meta-Llama-3.1-8B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-8B-Instruct-Q4_K_M.gguf",
            "llama31-8b-q4km.gguf"),
        ModelInfo("mistral-7b", "Mistral 7B", "Agent", "7B", 4100, 5f,
